...
typedef void (*AppCrashCallback)(bool isDump ,const QString &path,void *ctx);
...
public:
    ...
    void setAppCrashCallback(AppCrashCallback callback,void* ctx);
